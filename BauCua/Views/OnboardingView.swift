...
/// Three-page first-launch walkthrough: betting, rolling, payout. Shown once,
/// and re-accessible from Home via "How to Play" alongside the deeper Rules
/// reference sheet.
struct OnboardingView: View {
    ...
    private let pageKeys: [(title: String, body: String)] = [
        ("onboarding.bet.title", "onboarding.bet.body"),
        ("onboarding.shake.title", "onboarding.shake.body"),
        ("onboarding.payout.title", "onboarding.payout.body"),
    ]
